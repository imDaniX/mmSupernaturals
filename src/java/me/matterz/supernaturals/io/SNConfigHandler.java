...
public class SNConfigHandler {
	...
	public static final Set<Material> woodMaterials = new HashSet<>();
	public static final Set<EntityType> vampireTruce = new HashSet<>();
	public static final Set<Material> foodMaterials = new HashSet<>();
	public static final Set<Material> ghoulWeapons = new HashSet<>();
	public static final Set<Material> demonWeapons = new HashSet<>();
	public static final Set<Material> priestWeapons = new HashSet<>();
	public static final Set<Material> vampireWeapons = new HashSet<>();
	public static final Set<Material> hunterWeapons = new HashSet<>();
	public static final Set<Material> wereWeapons = new HashSet<>();
	public static final Set<Material> ghoulWeaponImmunity = new HashSet<>();
	public static final Set<EntityType> ghoulTruce = new HashSet<>();
	...
	public static final Set<Material> burnableBlocks = new HashSet<>();
	public static final Set<Material> hunterArmor = new HashSet<>();
	public static final Set<Material> ghoulArmor = new HashSet<>();
	public static final Set<Material> demonArmor = new HashSet<>();
	public static final Set<Material> priestArmor = new HashSet<>();
	public static final Set<Material> vampireArmor = new HashSet<>();
	public static final Set<Material> wereArmor = new HashSet<>();
	public static final Set<Material> enderWeapons = new HashSet<>();
